  ...
  return (
    <div className="rounded-2xl bg-white/70 p-4 shadow-soft backdrop-blur">
      <div className="flex items-center gap-2">
        ...
        <button
          onClick={onClear}
          className="shrink-0 rounded-xl border border-black/10 bg-white px-3 py-2.5 text-xs font-medium transition-all duration-200 hover:-translate-y-0.5 hover:bg-black/5 active:translate-y-0 active:scale-[0.98] md:px-4 md:py-3 md:text-sm"
